...
export default function MainLandingPage() {
  return (
    ...
    >
      ...
      <div className='grid justify-center items-center  sm:grid-cols-3 lg:gap-1   gap-10 sm:gap-2 [&>*]:rounded-[10px] [&>*]:text-center [&>*]:w-[168px] [&>*]:h-[120px] lg:mt-20 lg:pl-25   sm:pl-20'>

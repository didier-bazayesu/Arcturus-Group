...
export default function LandingPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative bg-[#0047AB] text-white py-24">
      ...
      <section className="bg-[#0047AB] text-white py-20">
        <div className="max-w-7xl mx-auto px-6 space-y-12 text-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            <div className="bg-white text-[#0047AB] p-6 rounded-lg shadow">
      ...
      {/* Call To Action */}
      <section id="contact" className="bg-[#0047AB] text-white py-20 text-center">
